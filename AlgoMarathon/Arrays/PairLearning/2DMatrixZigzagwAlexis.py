...
'''
Exercise to learn about the column major traversal: 
...
Expected Output: [1,  2,  3,  4,  5,  10,  9,  8,  7,  6, 11, 12, 13, 14, 15]
  
  
  function zigzagOrder(array) {
    const result = [];
  
    for (let i = 0; i < array.length; i++) { //outer array
      const row = array[i]; //hoisting 
      if (i % 2 === 0) { //even index
        // go forward
